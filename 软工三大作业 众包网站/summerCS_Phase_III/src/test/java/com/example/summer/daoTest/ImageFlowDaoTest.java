...
public class ImageFlowDaoTest {
    ImageFlowDaoImpl imageFlowDao = new ImageFlowDaoImpl(null,null);
    ImageDao imageDao = new ImageDaoImpl(null);
    ...
    public void testInitImages(){
        ...
        ArrayList<ImagePO> imagePOS = (ArrayList<ImagePO>) imageDao.listImagesByProjectId("proj123456");
