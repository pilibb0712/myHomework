...
public class WorkerController {
     ...
     *
     * */
    @RequestMapping("/worker/queryTags")
    public List<String> queryTagByProjectId(@Param("projectId") String projectId){
        return workerService.queryTagsByProjectId(projectId);
    }
}
