...
public interface ImageDao {
     ...
     * @return 该项目的图片信息
     * */
     List<ImagePO> listImagesByProjectId(String projectId);
     ...
     * @return 该用户的该项目的图片信息
     * */
    List<ImagePO> listImagesByProjectIdAndUserId(String projectId, String userId);//先写在这里，防止其他地方出错
     ...
     * @return 该项目的图片信息
     * */
   List<ImagePO> listImagesByProjectIdAndUserId(String projectId, String userId, int begin, int num);
     ...
     * @return 该项目的图片信息
     * */
    List<ImagePO> listCurrentImagesByProjectIdAndUserId(String projectId, String userId);
     ...
     * @return 该项目的图片信息
     * */
    List<ImagePO> listCurrentImagesByProjectIdAndUserId(String projectId, String userId,int begin, int num);
     ...
     * @return 是否储存成功
     * */
    boolean saveProjectImages(String projectId, List<ImagePO> images);
     ...
     */
    List<ImagePO> listLauncherImagesByProjectId(String projectId, int begin, int num);
