...
import com.example.summer.service.impl.LauncherServiceImpl;
...
public class LauncherController {
    ...
    private LauncherService launcherService = new LauncherServiceImpl();
     ...
     * @return 项目Id
     * */
    @RequestMapping("/launcher/launch/multi")
    public String createMultiCreditProject(@RequestParam("username") String username, @RequestBody MultiCreditProjectModel project){
        project.setProjectType(ProjectTypeEnum.MULTI);
        String projectId = launcherService.createProject(username,project);
        rankService.createProjectRank(projectId);
        return  projectId;
    }
    ...
    public boolean closeProject(@RequestParam("projectId") String projectId,String closeTime){
        return launcherService.closeProject(projectId,closeTime);
    }
     ...
     * @return 图片的标记
     * */
    @RequestMapping("/launcher/listMarkedImgs")
    public ArrayList<SingleUserImageModel> listMarkedImgByProjectId(@RequestParam("projectId") String projectId){
        return  launcherService.listMarkedImgByProjectId(projectId);
    }
