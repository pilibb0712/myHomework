...
public class ImageFlowDaoImpl implements ImageFlowDao {
    ...
    private static final String IMAGE_FLOW_PATH = DataAbsolutePath.DATA_PATH +"ImageFlow/";
    ...
    @Autowired
    public ImageFlowDaoImpl(ImageDao imageDao, ProjectDao projectDao){
    ...
    public boolean saveProjectImages( MultipartFile imagesFile, String projectId) {
        ...
        String fileDirName = "";
        System.out.println(IMAGE_FLOW_PATH+projectId);
