...
public class LauncherServiceImpl implements LauncherService {
    ...
    */
    ...
    @Override
    public ArrayList<SingleUserImageModel> listMarkedImgByProjectId(String projectId) {
        ProjectModel proj = ProjectModel.queryProjectById(projectId);
        return proj.listMarkedImgs();
    }
}
