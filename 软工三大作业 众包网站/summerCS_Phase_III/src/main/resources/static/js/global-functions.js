...
/***********************************************************************************************/
/*初始化base部分*/
function initBase($username, $currentUserDiv, $changeUserDiv, $anotherUsername, $anotherPassword, $changeUserBtn) {

    $username.html($.cookie('username'));

    $changeUserBtn.on('click', function () {
        var newUsername = $anotherUsername.val();
        var newPassword = $anotherPassword.val();
        console.log(newUsername);

        $.ajax({
            type: 'post',
            url: '/login?logStr=' + newUsername + '&password=' + newPassword,
